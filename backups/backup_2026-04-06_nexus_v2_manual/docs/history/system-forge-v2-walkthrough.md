...
- **Analyse Multimodale** : Support des PDF, Images et désormais **Markdown (.md)**.
- **Explorateur Local** : Scan automatique du dossier `docs/systems` pour importer vos PDF personnels.
