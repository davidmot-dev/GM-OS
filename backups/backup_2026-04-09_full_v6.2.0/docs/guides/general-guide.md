...
### Assistant Tactique (Cortex)

Accessible via l'Atlas, l'Assistant Tactique est votre copilote stratégique en combat.

- **Analyse Spatiale** : En un clic sur **"Analyser"**, le Cortex examine les positions des pions, les distances et les menaces pour suggérer des actions optimales.
- **Narration Stratégique** : Reçevez une description immersive de la situation pour enrichir votre narration de combat.
- **Conseils Typés** : Les suggestions sont classées par type (Attaque, Défense, Mouvement) et par priorité (Code couleur : Rouge = Critique).
- **Contrôles Matériels** : Gérez vos capteurs (audio), l'Auto-Dispel et les alertes visuelles (Hue Flash) directement depuis le panneau compact.
...
*Statut : Document à jour — Assistant Tactique (Cortex) intégré.*
