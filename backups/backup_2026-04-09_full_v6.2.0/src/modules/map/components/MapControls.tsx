                    ...
                    <div className="grid grid-cols-1 gap-2 px-1 mb-2">
                        ...
                        >
                            ...
                            <div className="text-left">
                                <span className="text-[10px] font-black uppercase tracking-widest block leading-none">Cortex Analytique</span>
                                <span className="text-[8px] opacity-60 uppercase font-bold">{isAnalyzing ? 'Analyse en cours...' : 'Lancer l\'Oracle'}</span>
                            </div>
                        </button>
                    </div>
