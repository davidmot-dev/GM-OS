...
## 🚀 Dernières Evolutions (Patch de Stabilité V5.1)
...
- **[ ] Echanges d'objets** : Permettre aux joueurs de se donner des objets via le Hub (nécessite validation MJ).
...
- **[ ] Deck-OS Intégration** : Utilisation de cartes d'initiative et de pouvoirs directement depuis le Hub.
- **[ ] Brouillard de Guerre Interactif** : Révélation de zones de l'Atlas Map directement par les joueurs (si autorisé).

### Q4 2026 : Écosystème & Intelligence Narrative
- **[ ] AI NPC Dialogue Prep** : Génération de répliques et de traits de caractère à la volée via l'Oracle pour les favoris.
- **[ ] Timeline Interactive** : Visualisation chronologique des événements de campagne générés depuis le Wiki.

---
*Dernière mise à jour : 30 Mars 2026*
*Statut : Vision de Développement BMAD*
