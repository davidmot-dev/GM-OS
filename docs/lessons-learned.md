...
**Problème :** Sur the Tablet Hub, les personnages s'affichaient avec le template "Générique" au lieu du template spécifique (ex: Cthulhu Hack), bien que les données soient correctes côté MJ.
...
*Statut : Tablet Hub finalisé & Forge synchronisée*
