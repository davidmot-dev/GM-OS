...
**Version 1.3 — 2026-09-26.** Adapté de la proposition « Architecture V2 — pipeline multi-agent de
...
**La boucle de travail est commune** aux deux constructeurs, thèmes et fiches :
[`Flux-des-constructeurs.md`](./Flux-des-constructeurs.md). Cette page porte les spécificités des
thèmes.
...
- **Rend un rapport à trois colonnes** pour chaque jeton : **appliqué maintenant**, **annoncé
  (V2)**, **sans effet (SDK)** — plus les erreurs, les avertissements et les contrastes chiffrés.
...
| Claude « implémenteur » du thème | Oui | RPG Theme Builder écrit le thème ; Claude Code **dépose** sans retoucher |
