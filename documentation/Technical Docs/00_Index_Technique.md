...
| [Light-OS](./Light-OS_Technical_Doc.md) | Le pont Philips Hue, scènes natives et effets logiciels. Depuis le 19/09 : la **relecture** du pont, les **râteliers par campagne**, ce qui entre dans la sauvegarde, et l’**ambiance composée par l’IA**. Le 20/09 : la **quatrième porte du retour** (l’essai d’une ambiance) et l’**atelier d’effets**, où un effet devient de la **donnée**. |
