# 🎭 Brouillard et calques

Cette page complète le [guide de Map-OS](./22-Map-OS-le-plateau.md). Elle ne redit pas où sont les
...
[guide de Map-OS](./22-Map-OS-le-plateau.md).
