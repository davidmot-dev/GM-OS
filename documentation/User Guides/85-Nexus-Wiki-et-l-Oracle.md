...
→ [Guide de l'Oracle](./80-Oracle-poser-une-question.md) pour le détail, les sources citées et le penchant.
...
→ [Guide du module Obsidian](./84-Nexus-Wiki-coffre-Obsidian.md)
