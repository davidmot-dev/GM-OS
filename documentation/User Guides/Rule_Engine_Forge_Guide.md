# 🔨 Guide : Forge-OS et l'éditeur de règles
...
| :--- | :--- |
| **Atelier** | Les fiches de règles écrites ou forgées → [les partager aux joueurs](./Rule_Sharing_Guide.md) |
...
→ [Guide de Dice-OS](./Dice_OS_User_Guide.md)
...
→ [Guide de Loot-OS](./Loot_System_Guide.md)
