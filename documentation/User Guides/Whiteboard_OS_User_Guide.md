# 🎨 Guide Utilisateur : Whiteboard-OS
...
### Personnalisation
- **Nuancier** : Choisissez parmi une sélection de couleurs vives ou le blanc par défaut.
- **Épaisseur** : Réglez la taille de votre trait pour plus de précision ou d'impact.
- **Mode Sombre/Clair** : Basculez entre un fond noir (standard GM-OS) ou un fond blanc pour plus de lisibilité.
...
- **Undo/Redo** : Revenez en arrière ou rétablissez vos derniers traits grâce aux flèches de navigation.
- **Tout Effacer (Corbeille)** : Nettoyez instantanément tout le plateau pour une nouvelle idée.
