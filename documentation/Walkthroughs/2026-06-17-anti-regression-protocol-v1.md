...
- **Fichier** : [validate.ps1](../../scripts/validate.ps1)
...
Une assertion incorrecte a été insérée temporairement dans [MapFogRegistry.test.ts](../../src/modules/map/__tests__/MapFogRegistry.test.ts).
