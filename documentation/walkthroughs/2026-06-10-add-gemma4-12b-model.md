...
- **Fichier modifié** : [AISettings.tsx](file:///c:/Projet_David/GM-OS-v5/src/modules/ai/components/AISettings.tsx)
...
- **Fichier modifié** : [settings.json (FR)](file:///c:/Projet_David/GM-OS-v5/src/locales/fr/settings.json)
- **Fichier modifié** : [settings.json (EN)](file:///c:/Projet_David/GM-OS-v5/src/locales/en/settings.json)
...
- **Fichier modifié** : [RemoteDicePad.tsx](file:///c:/Projet_David/GM-OS-v5/src/modules/remote/components/RemoteDicePad.tsx)
