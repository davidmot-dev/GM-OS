...
> [!NOTE]
> Le Social Nexus est désormais le point central de la gestion politique de vos campagnes. Pour plus de détails, consultez le [Guide Utilisateur Session OS](file:///c:/Projet_David/GM-OS-v5/doc./user-guides/Session_OS_User_Guide.md).
