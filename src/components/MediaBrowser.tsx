...
import { Search, Image as ImageIcon, Music, Film, UploadCloud, Trash2, X, Check, FileText, Tag, Plus, Edit2, Users, Clock, ShieldAlert, ArrowDownAZ, ChevronDown, ListFilter, Folder } from 'lucide-react';
                                ...
                                {displayMedia.map(media => (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {/* HUD Type Icon Badge */}
                                            <div className="absolute top-6 left-6 w-10 h-10 rounded-2xl bg-black/40 backdrop-blur-md border border-white/10 flex items-center justify-center text-white/40 opacity-60 group-hover:opacity-100 group-hover:text-[#53ddfc] group-hover:border-[#53ddfc]/20 transition-all duration-500">
