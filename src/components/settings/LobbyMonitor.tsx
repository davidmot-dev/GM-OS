            ...
            <div className="bg-slate-950/50 p-3 border-t border-white/5 shrink-0">
                <div className="flex items-center justify-between gap-3 mb-2">
                    ...
                    <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 bg-rose-500/10 hover:bg-rose-500/30 border border-rose-500/30 text-rose-400 hover:text-rose-300 rounded-lg text-ui-10 font-black uppercase tracking-widest transition-all active:scale-95 whitespace-nowrap"
