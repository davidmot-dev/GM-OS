    ...
    return (
        <div className="h-full overflow-hidden grid grid-cols-12 gap-6 p-6 bg-app-bg text-app-text">
            ...
            <div className="col-span-4 overflow-y-auto custom-scrollbar space-y-4 pr-1">
                ...
                <Bloc icone={<ScrollText size={16} />} titre="Ce que le disque porte">
                    {!lecture ? (
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-ui-10 uppercase tracking-widest font-bold text-app-text/30 pt-1">
                            ...
                            {lecture.ecartees.map(e => (
                                <p key={e.sujet} className="text-ui-11 text-app-text/35 leading-relaxed">
                ...
                {avancement && (
                    <p className="text-ui-11 text-app-text/45 text-center leading-relaxed">
                    ...
                    <>
                        <Bloc icone={<Network size={16} />} titre="La trame forgée">
                            ...
                            {resultat.projet.campagne && (
                                <p className="text-ui-11 text-app-text/45 leading-relaxed mt-3">
                                ...
                                <div className="space-y-3">
                                    {resultat.projet.actes.map(acte => (
                                        <div key={acte.titre}>
                                            ...
                                            <p className="text-ui-11 text-app-text/40 italic leading-relaxed">
                                            ...
                                            <ul className="mt-1 space-y-0.5">
                                                {resultat.projet.scenes
                                                    ...
                                                    .map(s => (
                                                        <li key={s.titre} className="text-ui-11 text-app-text/55 pl-3">
                                                            · {s.titre}
                            ...
                            <Bloc icone={<AlertTriangle size={16} />} titre="Ce qui manque">
                                <div className="space-y-2">
                                    ...
                                    {resultat.echecs.map((e, i) => (
                                        <p key={`${e.groupe}-${e.acte ?? ''}-${i}`} className="text-ui-11 text-app-text/40 leading-relaxed">
                        ...
                        {ecrit && (
                            <Bloc icone={<Info size={16} />} titre="Ce que l'écriture a fait">
                                <div className="space-y-2">
                                    <p className="text-ui-11 text-app-text/50 leading-relaxed">
                                    ...
                                    */}
                                    {ecrit.approximatifs.length > 0 && (
                                        <div className="space-y-1 pt-1">
                                            ...
                                            <p className="text-ui-11 text-app-text/35 italic leading-relaxed pt-1">
...
const Compte: React.FC<{ icone: React.ReactNode; nombre: number; quoi: string }> = ({ icone, nombre, quoi }) => (
    <p className={`flex items-center gap-2 text-ui-11 ${nombre === 0 ? 'text-app-text/25' : 'text-app-text/60'}`}>
