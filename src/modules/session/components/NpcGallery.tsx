...
const NpcGalleryItem: React.FC<{ 
    ...
    return (
        <div
            onClick={onSelect}
            className={`group relative h-96 rounded-2xl overflow-hidden cursor-pointer transition-all border border-app-border bg-app-surface/40 backdrop-blur-md hover:border-accent/30 ${
        ...
        >
            ...
            {/* Content Area */}
            <div className="p-6 h-48 flex flex-col relative">
                {/* Role Badge */}
